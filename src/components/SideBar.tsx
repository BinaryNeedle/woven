...
import { JSXElement, Component, createResource, Suspense } from "solid-js";
...
const SideBar: Component<SideBarProps> = (props): JSXElement => {
			...
			<aside class="w-full bg-[#0E8388] flex flex-col justify-between shadow-lg h-dvh">
				<section class="grid grid-cols-1">
					<section class="justify-self-center my-10">
						...
						<img
							src={`${props.hostName}/assets/svg/App Title.svg`}
							alt="Woven Logo"
						/>
					</section>
					<section class="px-5 mb-10 relative bg-[#17394D] rounded-lg input-container-text flex">
						<input
							...
							class="input-field text-slate-300 focus:text-white"
							type="text"
						/>
						<label for="input-field" class="input-label"></label>
						<span class="input-highlight"></span>
						<img src={`${props.hostName}/assets/svg/search.svg`} alt="Search" />
					</section>
					...
					<section>
						...
						<section id="conversation">
							...
							.map((user) => (
								<a
									href="/chat"
									class="grid grid-cols-5 p-3 hover:cursor-pointer hover:bg-[#17394D] border-t border-[#17394D]"
								>
									<img
				...
				<section class="grid grid-cols-4 px-8 bg-[#17394D] py-4">
					<section class="col-span-3 flex items-center">
						<img
							src={`${props.hostName}/assets/svg/Online Status.svg`}
							alt="Online Status"
						/>
						<img
							src={`${props.hostName}/assets/svg/Conversation Image.svg`}
					...
					<a
						href="/setting"
						class="group mx-auto my-auto relative cursor-pointer"
					>
						<span>
							<img
								src={`${props.hostName}/assets/svg/settingsIcon.svg`}
								alt="Menu"
							/>
						</span>
						<div class="bg-[#2C3333] p-2 rounded-md group-hover:flex hidden absolute -top-2 -translate-y-full left-1/2 -translate-x-1/2">
